...
public class Adapter_attractions extends ArrayAdapter {

    public Adapter_attractions(Context context, List objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(listItemView == null) {
            listItemView = LayoutInflater.from(getContext())
                    .inflate(R.layout.adapter_view_attractions, parent, false);
        }
