...
public class Adapter_food extends ArrayAdapter {
    public Adapter_food(Context context, List objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(listItemView == null){
            listItemView = LayoutInflater.from(getContext())
                    .inflate(R.layout.adapter_view_food, parent, false);
        }
        ...
        TextView textView = listItemView.findViewById(R.id.textViewAdapter);
        textView.setText(currentItem.getName());
        TextView textView1 = listItemView.findViewById(R.id.location_view_adapter);
