...
public final class Utils {
    ...
    private static Weather extractFeatureFromJson(String jsonResponse) {
        ...
        try {
            ...
            JSONObject main = new JSONObject(baseJsonResponse.getString("main"));
            ...
            return new Weather(temperature, humidity, weather_main);
